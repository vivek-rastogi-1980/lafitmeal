...
use App\Filament\Resources\Meals\RelationManagers\CookingStepsRelationManager;
use App\Filament\Resources\Meals\RelationManagers\IngredientsRelationManager;
...
class MealResource extends Resource
{
    ...
    public static function getRelations(): array
    {
        return [
            ...
            CookingStepsRelationManager::class,
        ];
    }
